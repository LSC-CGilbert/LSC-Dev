...
var config = {
    map: {
        '*': {
            amLayoutBuilder: 'Amasty_CheckoutLayoutBuilder/js/layout-builder/build/layout-builder.bundle',
            amUseDefaultStateManager: 'Amasty_CheckoutLayoutBuilder/js/model/default-state-manager'
        }
    }
};
...
var config = {
    config: {
        mixins: {
            'mage/validation': {
                'Amasty_MegaMenuPremium/js/validate-am-decimal': true
            }
        }
    },
    map: {
        '*': {
            mediabrowserUtility: 'mage/adminhtml/browser'
        }
    }
};
...
var config = {
    config: {
        mixins: {
            'Magento_Ui/js/lib/validation/validator': {
                'Amasty_ProductAttachment/js/form/validator-rules-mixin': true
            }
        }
    }
};
...
var config = {
    map: {
        '*': {
            mageSortable: 'Magento_Theme/js/sortable',
            ruleSuggest: 'Amasty_ThankYouPage/js/rule-suggest'
        }
    }
};
