...
class Configurable
{
    ...
    public function afterGetJsonConfig(\Magento\Swatches\Block\Product\Renderer\Configurable $subject, $result) 
    {
        ...
        if ($this->helper->getConfig('cynoinfotech_dynamicconfigurableproduct/general/enable')) {
            ...
            $descriptionsIsEnable=
            $this->helper->getConfig('cynoinfotech_dynamicconfigurableproduct/general/dynamic_description');
            $shortdescriptionsIsEnable=
            $this->helper->getConfig('cynoinfotech_dynamicconfigurableproduct/general/dynamic_shortdescription');
