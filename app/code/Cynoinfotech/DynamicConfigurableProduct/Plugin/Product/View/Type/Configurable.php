 ...
 */  
namespace Cynoinfotech\DynamicConfigurableProduct\Plugin\Product\View\Type;
...
class Configurable
{
        ...
        $result) 
    {
        if ($this->helper->getConfig('cynoinfotech_dynamicconfigurableproduct/general/enable')) {
            $skusIsEnable=$this->helper
            ->getConfig('cynoinfotech_dynamicconfigurableproduct/general/dynamic_sku');
            $namesIsEnable=$this->helper->
            getConfig('cynoinfotech_dynamicconfigurableproduct/general/dynamic_Name');
            $descriptionsIsEnable=$this->helper->
            getConfig('cynoinfotech_dynamicconfigurableproduct/general/dynamic_description');
            $shortdescriptionsIsEnable=$this->helper->
            getConfig('cynoinfotech_dynamicconfigurableproduct/general/dynamic_shortdescription');
            
            $jsonResult = json_decode($result, true);
            $jsonResult['skus'] = array();
            $jsonResult['names'] = array();
            $jsonResult['descriptions'] = array();
            $jsonResult['shortdescriptions'] = array();    
